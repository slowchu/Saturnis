...
- Device models include deterministic semantics for representative SMPC/SCU/VDP/SCSP registers via reset-value and writable-mask behavior (including VDP2 TVMD/TVSTAT).
