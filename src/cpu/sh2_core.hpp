...
private:
  ...
  [[nodiscard]] bool decode_mov_load_postinc(std::uint16_t instr, std::uint8_t &n, std::uint8_t &m,
                                             std::uint8_t &size) const;
  [[nodiscard]] bool decode_mov_store_disp(std::uint16_t instr, std::uint8_t &n, std::uint8_t &m,
                                           std::uint8_t &size, std::uint32_t &disp_bytes) const;
  [[nodiscard]] bool decode_mov_load_disp(std::uint16_t instr, std::uint8_t &n, std::uint8_t &m,
                                          std::uint8_t &size, std::uint32_t &disp_bytes) const;
